...
public class ModBlocks {
    public static final Block TRADING_POST       = new TradingPostBlock(AbstractBlock.Settings.create().strength(2.5f).requiresTool());
    ...
    public static void register() {
        Registry.register(Registries.BLOCK, id("trading_post"),       TRADING_POST);
